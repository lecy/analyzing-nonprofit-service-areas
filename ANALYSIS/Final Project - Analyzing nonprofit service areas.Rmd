...
#DROP Vars with NAs
pov_orgs$PFFRCD <- pov_orgs$TAXPER <- NULL

```


## Geocode selected Poverty Organization data
``````{r eval=FALSE}
print("Don't run me")
...
## Create Service Catchment Area data
```{r, message=FALSE, warning=FALSE}
library( sp )  
library( rgeos )
library( spatialEco ) 
...
rename(acs_2015_syr, 
       c("B25077_001E" = "mdn_hous_val", "B25003_001E" = "tenure_tot", 
         "B25003_002E" = "tenure_own", "B25003_003E" = "tenure_rent",
         "B25002_001E" = "tot_occup", "B25002_002E" = "occupied",
         "B25002_003E" = "vacant", "B01003_001E" = "tot_pop",       
         "B02001_001E" = "tot_race", "B02001_002E" = "white",             
         "B02001_003E" = "black", "B02001_004E" = "am_ind",
         "B02001_005E" = "asian", "B02001_006E" = "islander",
         "B02001_007E" = "other", "B02001_008E" = "mixed",
